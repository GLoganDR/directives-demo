(function(){
  ...
  angular.module('grGreetingModule', [])//the empty array makes sure it doesn't fail if grGreetingModule is empty//
  //works like a controller, needs a name and dependencies//
  .directive('grGreeting', [function(){ //html will look for lower case gr-greeting//
    ...
    o.templateUrl = '/components/directives/gr-greeting/gr-greeting.html'; //Path to the HTML page//
    o.scope = {name:'@', age:'@'};   // Can equal false, true, or an empty object {} //
